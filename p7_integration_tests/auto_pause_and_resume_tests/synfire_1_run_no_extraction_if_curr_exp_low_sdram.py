...
#from ../../..tools.spike_checker import synfire_spike_checker
...
class Synfire1RunNoExtractionIfCurrExpLowSdram(unittest.TestCase):
    ...
    def test_run(self):
        ...
        # plot_utils.heat_plot(gsyn, title="v")
