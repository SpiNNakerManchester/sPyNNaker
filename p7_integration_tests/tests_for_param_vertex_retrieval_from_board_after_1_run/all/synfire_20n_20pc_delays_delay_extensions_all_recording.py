...
## TODO christian fix into intergation test format
...
# TODO chistian this is the valid call that when pushed through all should
# make it work, mind out that 0,0,1 isnt valid, 0,0,2 seems to work.
populations[0].add_placement_constraint(x=0, y=0, p=2)
