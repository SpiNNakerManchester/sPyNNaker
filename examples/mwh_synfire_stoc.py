...
nNeurons = 10000 # number of neurons in each population
max_delay = 50
#p.set_number_of_neurons_per_core("IF_curr_exp", nNeurons / 2)
#p.set_number_of_neurons_per_core("DelayExtension", nNeurons / 2)


cell_params_lif = {  'tau_m'     : 20.0,
                     'cm'      : 1.0, # nF
                     'e_rev_E' : 0.0,
                     'e_rev_I' : -70.0,
                     'v_rest'    : -65.0,
...
populations.append(p.Population(nNeurons, p.IF_cond_exp_stoc, cell_params_lif, label='pop_1'))
