...
inh_pop2 = Projection(pop_inhibit, 
                      mapped_pop_2,
                      FixedProbabilityConnector(p_connect=0.5, allow_self_connections=True, weights=weight_dependence_i, delays=4.0), 
                      target='inhibitory')

pop1_pop2 = Projection(mapped_pop_1,
                       mapped_pop_2,
                       FixedProbabilityConnector(p_connect=0.5, allow_self_connections=True, weights=weight_dependence_e, delays=4.0),
                       target='excitatory')
