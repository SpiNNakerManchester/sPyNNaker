...
class TestIFCurrDualExpModel(unittest.TestCase):
    ...
    def test_new_if_curr_dual_exp_model(self):
        ...
        self.assertEqual(if_curr_dual_exp._tau_refrac,cell_params_lif['tau_refrac'])

        self.assertEqual(if_curr_dual_exp._tau_syn_I,cell_params_lif['tau_syn_I'])
        self.assertEqual(if_curr_dual_exp._tau_syn_E,cell_params_lif['tau_syn_E'])
        self.assertEqual(if_curr_dual_exp._i_offset,cell_params_lif['i_offset'])
