...
class WeightDependenceMFVN(_BaseClass):
    ...
    .. deprecated:: 6.0
        Use
        :py:class:`spynnaker.pyNN.models.neuron.plasticity.stdp.weight_dependence.WeightDependenceMFVN`
        instead.
    """
    __slots__ = []
    ...
    def __init__(self, w_min=0.0, w_max=1.0, pot_alpha=0.01):
        ...
        moved_in_v6("spynnaker8.models.synapse_dynamics.weight_dependence"
                    ...
                    "weight_dependence.WeightDependenceMFVN")
