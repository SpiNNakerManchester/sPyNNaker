...
#ifndef _SYNAPSE_STRUCUTRE_BERN_IMPL_H_
#define _SYNAPSE_STRUCUTRE_BERN_IMPL_H_
...
// The final state is just a weight and delta as this is
...
static inline final_state_t synapse_structure_get_final_state(
    ...
    return (final_state_t) {
        ...
        .prev_delta = weight_get_delta(state)
    };
}
...
//---------------------------------------
static inline weight_t synapse_structure_get_final_synaptic_word(
        final_state_t final_state) {
    return final_state.weight;
}

static inline REAL synapse_structure_get_final_synaptic_delta(
        final_state_t final_state) {
    return final_state.prev_delta;
}

#endif  // _SYNAPSE_STRUCUTRE_BERN_IMPL_H_
