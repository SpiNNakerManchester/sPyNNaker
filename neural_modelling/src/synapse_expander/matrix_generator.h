 ...
 * \param[in] delayed_synaptic_matrix:
 ...
 * \param[in] max_delayed_row_n_synapses:
 *      The maximum number of synapses in a delayed row
 ...
 *      The start of the slice of the post-population being generated
 * \param[in] post_slice_count:
 *      The number of neurons in the slice of the post-population being generated
 * \param[in] pre_slice_start:
 *      The start of the slice of the pre-population being generated
 * \param[in] pre_slice_count:
 *      The number of neurons in the slice of the pre-population being generated
