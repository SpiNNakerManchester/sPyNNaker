...
static void matrix_generator_static_write_row(
    ...
    // delay stage)
    static_row_t row_address[max_stage];
    ...
    for (uint32_t synapse = 0; synapse < n_synapses; synapse++) {
        ...
        row_address[delay.stage]->fixed_fixed_size++;
        space[delay.stage]--;
    }
}
