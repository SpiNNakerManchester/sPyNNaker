...
/**
 * \brief Initialise the constant parameter generator
...
/**
 * \brief Free any data for the constant parameter generator
...
/**
 * \brief Generate values with the constant parameter generator
