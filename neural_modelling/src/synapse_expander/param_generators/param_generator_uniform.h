...
/**
 * \brief Initialise the uniform RNG parameter generator
...
/**
 * \brief Free any data for the uniform RNG parameter generator
...
/**
 * \brief Generate values with the uniform RNG parameter generator
