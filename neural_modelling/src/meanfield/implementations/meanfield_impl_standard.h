...
#ifndef _MEANFIELD_IMPL_STANDARD_H_
#define _MEANFIELD_IMPL_STANDARD_H_
...
#include <meanfield/synapse_types/synapse_types_exponential_impl.h>*/
...
static bool neuron_impl_do_timestep_update(index_t meanfield_index, input_t external_bias){
    ...
    mathsbox_t *mathsbox_types = &mathsbox_types[meanfield_index];
