...
//        additional_input->g_NaP = 0.5k;
        ...
        additional_input->m_inf_NaP = 1k / (1k
                                  + expk(-(membrane_voltage+55.70001220703125k)*ulrbits(557787961))); // 1/7.7 = 0.129870129
...
//--////-//------------------------------------------------------------------------
        ...
        additional_input->D_influx = ulrbits(4294967) + 1250.0k * ulrbits(107374182)
                                       / (1.0k + expk(-(membrane_voltage - -10.0k) * ulrbits(858993459))); //1/5 = 0.2
