#ifndef STDP_TRACE_NEAREST_PAIR_IMPL
#define STDP_TRACE_NEAREST_PAIR_IMPL
  ...
  deferred_update_state_t previous_state)
{
  ...
  int32_t decayed_o1_trace = STDP_TRACE_DECAY_LOOKUP_TAU_MINUS(time_since_last_post_event);
  ...
  deferred_update_state_t previous_state)
{
  ...
  int32_t decayed_r1_trace = STDP_TRACE_DECAY_LOOKUP_TAU_PLUS(time_since_last_pre_event);
