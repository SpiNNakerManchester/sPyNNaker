#ifndef _WEIGHT_FUSI_IMPL_H_
#define _WEIGHT_FUSI_IMPL_H_
...
static inline weight_state_t weight_one_term_apply_depression(
    ...
    state.a2_minus += state.weight_region->a2_minus;
    return state;
}
