...
static inline final_state_t eprop_plasticity_update(
	...
	// THIS NEEDS UPDATING TO APPROPRIATE SCALING
	...
	// Regularisation error isn't used in this case
	REAL reg_error = 0.0;
...
bool synapse_dynamics_process_plastic_synapses(
    ...
    // Could maybe have a single z_bar for the entire synaptic row
    // and update it once here for all synaptic words?
    ...
    for (; plastic_synapse > 0; plastic_synapse--) {
        ...
        // !!!! Check what units this is in - same as weight? !!!!
    	...
    	if (neuron->syn_state[syn_ind_from_delay].update_ready <= 0) {
    		...
    		neuron->syn_state[syn_ind_from_delay].update_ready += 1024;
        ...
        // TODO: no overflow or underflow checking?
...
//       plasticity can be used if desired?
