...
bool synapse_dynamics_initialise(
    ...
    bool meets_dynamics_magic_number =
        synapse_dynamics_magic_number == SYNAPSE_DYNAMICS_STDP_MAD;
    ...
    if (!meets_dynamics_magic_number || !meets_plastic_structure){
        log_error("expected magic number 0x%x, 0x%x got magic number 0x%x, "
                  " 0x%x instead.",
                  SYNAPSE_DYNAMICS_STDP_MAD, SYNAPSE_PLASTIC_STRUCTURE_WEIGHT,
