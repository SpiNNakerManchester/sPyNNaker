...
// At this point do we also need to define synapse_dynamics_find_neuron,
// synapse_dynamics_remove_neuron, control_conversion, synapse_dynamics_add_neuron
// and synapse_dynamics_n_connections_in_row ?
