...
//    		neuron_impl->exc_input_value, input_type, voltage);
    exc_input_value =
    		input_type_get_input_value(exc_value, input_type);
    exc_input = input_type_convert_excitatory_input_to_current(
...
//    		neuron_impl->inh_input_value, input_type, voltage,
//			neuron_impl->exc_input);
    inh_input_value =
    		input_type_get_input_value(inh_value, input_type);
    inh_input = input_type_convert_inhibitory_input_to_current(
