...
void c_main_store_provenance_data(address_t provenance_region) {
    ...
    prov->ghost_pop_table_searches =
        spike_processing_get_ghost_pop_table_searches();
    prov->failed_to_read_bit_fields = failed_bit_field_reads;
    prov->dma_completes = spike_processing_get_dma_complete_count();
    prov->spike_processing_count =
        spike_processing_get_spike_processing_count();
    prov->invalid_master_pop_hits =
