...
//! then defaults to 1ms time step
...
//! \param[in] neuron the pointer to a neuron parameter struc which contains
...
//! \param[in] neuron a pointer to a neuron parameter struc which contains
//! all the parameters for a specific neuron
...
//! \param[in] neuron a pointer to a neuron parameter struc which contains all
