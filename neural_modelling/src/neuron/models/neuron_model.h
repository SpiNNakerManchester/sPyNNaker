...
//! \brief Tell the model for a specific neuron that it has has spiked
//! \param[in, out] neuron: The neuron parameter struct which contains
...
//! \brief Print state variables i.e. those values that might change each
//!     timestep
...
//! \brief Print parameters i.e. those values that don't usually change for the
