...
#define MIN_HR( a, b ) ( ( (macro_arg_1=(a)) <= (macro_arg_2=(b)) ) ?\
        macro_arg_1 : macro_arg_2 )
#define MAX_HR( a, b ) ( ( (macro_arg_1=(a)) > (macro_arg_2=(b)) ) ?\
        macro_arg_1 : macro_arg_2 )
#define SQR( a ) ( (macro_arg_4=(a)) == ZERO ?\
        ZERO : macro_arg_4 * macro_arg_4 )
#define CUBE( a ) ( (macro_arg_3=(a)) == ZERO ?\
        ZERO : macro_arg_3 * macro_arg_3 * macro_arg_3 )
