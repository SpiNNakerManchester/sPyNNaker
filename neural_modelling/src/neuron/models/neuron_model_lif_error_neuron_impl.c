#include "neuron_model_lif_error_neuron_impl.h"
...
static inline void _local_error_update(
    ...
    neuron->local_err = alpha - (neuron->exp_TC_err * (alpha - V_prev));
}
...
//		}
        ...
        _local_error_update(neuron, neuron->local_err, exc_input[1]);
    ...
    // Update label trace (integrated through refractory period)
    _local_error_update(neuron, neuron->local_err, exc_input[1]);
