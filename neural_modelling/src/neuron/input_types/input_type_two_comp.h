...
// Input type for two-compartment Bern neuron:
// Synapse type 0 -> soma, conductance based excitatory (teacher)
// Synapse type 1 -> dendrite, current based excitatory (learning)
// Synapse type 2 -> soma, conductance based excitatory (teacher)
// Synapse type 3 -> dendrite, current based excitatory (learning)
...
//    }
	...
	// Convert conductance based (teacher) input
	        exc_input[0] = exc_input[0] *
	                (input_type->Teach_rev_E - membrane_voltage);
...
//    }
	...
	// Convert conductance based (teacher) input
	        inh_input[0] = -inh_input[0] *
	                (input_type->Teach_rev_I - membrane_voltage);
