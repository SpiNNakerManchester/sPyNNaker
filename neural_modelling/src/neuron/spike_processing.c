...
static NO_INLINE void _multicast_packet_received_callback(
...
static NO_INLINE void _user_event_callback(uint unused0, uint unused1) {
    use(unused0);
    use(unused1);
...
static NO_INLINE void _dma_complete_callback(uint unused, uint tag) {
    use(unused);
