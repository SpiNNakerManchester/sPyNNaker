...
$(BUILD_DIR)neuron/spike_processing.o: $(NEURON_MODIFIED_DIR)neuron/spike_processing.c
	#spike_processing.c
	-@mkdir -p $(dir $@)
	$(SYNAPSE_TYPE_COMPILE) -o $@ $<
...
$(BUILD_DIR)neuron/neuron.o: $(NEURON_MODIFIED_DIR)neuron/neuron.c $(NEURON_INCLUDE_FILES) $(MAKEFILE_LIST)
	# neuron.o
	-@mkdir -p $(dir $@)
