...
CHECK_PATH := $(NEURAL_MODELLING_DIRS)/makefiles/meanfield_fixing/meanfield_build.mk
...
ifndef MEANFIELD_IMPL_STD_H
    $(error MEANFIELD_IMPL_STD_H is not set.  Please select a neuron implementation)
else
    MEANFIELD_IMPL := $(call strip_source_dirs,$(MEANFIELD_IMPL_STD_H))
    MEANFIELD_IMPL_STD_H := $(call replace_source_dirs,$(MEANFIELD_IMPL_STD_H))
    MEANFIELD_IMPL_STANDARD := meanfield_fixing/implementations/meanfield_impl_standard.h
    MEANFIELD_INCLUDES := -include $(MEANFIELD_IMPL_STD_H)
    ifeq ($(MEANFIELD_IMPL), $(MEANFIELD_IMPL_STANDARD))
		...
		ifndef ADDITIONAL_INPUT_H
		    ADDITIONAL_INPUT_H = $(MODIFIED_DIR)meanfield_fixing/additional_inputs/additional_input_none_impl.h
		else
		    ADDITIONAL_INPUT_H := $(call replace_source_dirs,$(ADDITIONAL_INPUT_H))
		endif
		
		ifndef MEANFIELD_MODEL_H
		    $(error MEANFIELD_MODEL_H is not set.  Please choose a neuron model to compile)
		else
		    MEANFIELD_MODEL_H := $(call strip_source_dirs,$(MEANFIELD_MODEL_H))
		endif
		
		ifndef MEANFIELD_MODEL_IMPL
		    $(error MEANFIELD_MODEL_IMPL is not set.  Please choose a neuron model to compile)
		else
		    MEANFIELD_MODEL_IMPL := $(call strip_source_dirs,$(MEANFIELD_MODEL_IMPL))
		endif
		
		ifndef MEANFIELD_MODEL_IMPL_H
		    $(error MEANFIELD_MODEL_IMPL_H is not set.  Please choose a neuron model to compile)
		else
		    MEANFIELD_MODEL_IMPL_H := $(call replace_source_dirs,$(MEANFIELD_MODEL_IMPL_H))
		endif
		...
		MEANFIELD_INCLUDES := \
	      ...
	      -include $(MEANFIELD_MODEL_IMPL_H) \
	      -include $(CONFIG_H) \
          -include $(MATHSBOX_H) \
...
ifndef SYNAPSE_DYNAMICS
    ...
    SYNAPSE_DYNAMICS_STATIC := meanfield_fixing/plasticity/synapse_dynamics_static_impl.c
    STDP_ENABLED = 0
...
ifndef SYNAPTOGENESIS_DYNAMICS
    SYNAPTOGENESIS_DYNAMICS := meanfield_fixing/structural_plasticity/synaptogenesis_dynamics_static_impl.c
...
SOURCES = meanfield_fixing/c_main.c \
          meanfield_fixing/synapses.c \
          meanfield_fixing/direct_synapses.c \
          meanfield_fixing/meanfield.c \
          meanfield_fixing/meanfield_recording.c \
          meanfield_fixing/models/meanfield_model_impl.c \
          meanfield_fixing/spike_processing.c \
          meanfield_fixing/population_table/population_table_$(POPULATION_TABLE_IMPL)_impl.c \
...
$(BUILD_DIR)meanfield_fixing/c_main.o: $(MODIFIED_DIR)meanfield_fixing/c_main.c
	#c_main.c
	-@mkdir -p $(dir $@)
	$(SYNAPSE_TYPE_COMPILE) -o $@ $<

$(BUILD_DIR)meanfield_fixing/synapses.o: $(MODIFIED_DIR)meanfield_fixing/synapses.c
	#synapses.c
	-@mkdir -p $(dir $@)
	$(SYNAPSE_TYPE_COMPILE) -o $@ $<
    
$(BUILD_DIR)meanfield_fixing/direct_synapses.o: $(MODIFIED_DIR)meanfield_fixing/direct_synapses.c
	#direct_synapses.c
	-mkdir -p $(dir $@)
	$(SYNAPSE_TYPE_COMPILE) -o $@ $<

$(BUILD_DIR)meanfield_fixing/spike_processing.o: $(MODIFIED_DIR)meanfield_fixing/spike_processing.c
	#spike_processing.c
	-@mkdir -p $(dir $@)
	$(SYNAPSE_TYPE_COMPILE) -o $@ $<

$(BUILD_DIR)meanfield_fixing/population_table/population_table_binary_search_impl.o: $(MODIFIED_DIR)meanfield_fixing/population_table/population_table_binary_search_impl.c
...
ifeq ($(STDP_ENABLED), 1)
    ...
    $(BUILD_DIR)meanfield_fixing/plasticity/common/post_events.o: $(MODIFIED_DIR)meanfield_fixing/plasticity/common/post_events.c
...
$(BUILD_DIR)meanfield_fixing/meanfield.o: $(MODIFIED_DIR)meanfield_fixing/meanfield.c
	# meanfield.o
	-@mkdir -p $(dir $@)
	$(CC) -DLOG_LEVEL=$(NEURON_DEBUG) $(CFLAGS) $(MEANFIELD_INCLUDES) -o $@ $<

$(BUILD_DIR)meanfield_fixing/meanfield_recording.o: $(MODIFIED_DIR)meanfield_fixing/meanfield_recording.c
	# meanfield_recording.o
	-@mkdir -p $(dir $@)
	$(CC) -DLOG_LEVEL=$(NEURON_DEBUG) $(CFLAGS) $(MEANFIELD_INCLUDES) -o $@ $<

$(BUILD_DIR)meanfield_fixing/models/meanfield_model_impl.o: $(MODIFIED_DIR)meanfield_fixing/models/meanfield_model_impl.c
	# models/meanfield_model_impl.o
	-@mkdir -p $(dir $@)
	$(CC) -DLOG_LEVEL=$(NEURON_DEBUG) $(CFLAGS) $(MEANFIELD_INCLUDES) -o $@ $<
