...
class ChipPage(AbstractPage):
    ...
    def __init__(self, chip, chip_placements, router_table, window_based=True):
        ...
        core_table.show()
        self._update_table(core_table, self._coords, ChipPage.LOGICAL_VIEW)
        ...
        self._update_routing_table_page(routing_page, self.router_table)
    ...
    def _update_routing_table_page(self, routing_page, chip_router_table):
        ...
        for router_key in chip_router_table.keys():
            ...
            route_label = gtk.Label("{}".format(self.uint32_to_hex_string(route)))
    ...
    def _update_table(self, core_table, view):
    ...
    def update_table(self, option):
        ...
        if option:
            self._update_table(self.core_table, ChipPage.LOGICAL_VIEW)
        else:
            self._update_table(self.core_table, ChipPage.PHYSICAL_VIEW)
