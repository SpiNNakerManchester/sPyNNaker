...
from spynnaker.pyNN.projections.projection_partitionable_edge \
...
class DelayPartitionableEdge(ProjectionPartitionableEdge):
    ...
    def create_subedge(self, presubvertex, presubvertex_slice,
                       postsubvertex, postsubvertex_slice, constraints=None,
                       label=None):
        """
        """
        ...
        return DelayPartitionedEdge(
            self, presubvertex, presubvertex_slice, postsubvertex,
