...
class Spinnaker(SpinnakerMainInterface):
    ...
    def __init__(
        ...
        print "Spinnaker violate_1ms_wall_clock_restriction: " + str(
            config.getboolean("Mode", "violate_1ms_wall_clock_restriction"))
        if (config.has_option("Machine", "timeScaleFactor") and config.get(
                "Machine", "timeScaleFactor") != "None"):
            print "Spinnaker timeScaleFactor: " + str(
                config.getint("Machine", "timeScaleFactor"))
        else:
            print "Spinnaker NO timeScaleFactor: "
