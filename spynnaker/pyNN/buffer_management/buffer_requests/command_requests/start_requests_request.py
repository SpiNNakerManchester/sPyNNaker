...
from spynnaker.pyNN.buffer_management.buffer_requests.abstract_requests.abstract_command_request import \
    AbstractCommandRequest


class StartRequestsRequest(AbstractCommandRequest):
