...
def minimise(routing_table, target_length,
    ...
    :type routing_table: [:py:class:`~rig.routing_table.RoutingTableEntry`, ...]
    ...
    :param target_length: Target length of the routing table; the minimisation\
        ...
        minimisation is possible. If None then the table will be made as small \
        as possible.
    ...
    table, _ = ordered_covering(
        routing_table=routing_table, target_length=target_length, no_raise=True,
...
def ordered_covering(
    ...
    :param target_length: Target length of the routing table; the \
        minimisation procedure will halt once either this target is reached or\ 
        no further minimisation is possible. If None then the table will be \
        made as small as possible.
    :type aliases : {(key, mask): {(key, mask), ...}, ...}
    :param aliases: Dictionary of which keys and masks in the routing table are\
