...
class ProjectionPartitionableEdge(PartitionableEdge):
    ...
    def __init__(self, presynaptic_population, postsynaptic_population, machine_time_step,
                 ...
                 label=None):
        PartitionableEdge.__init__(self, presynaptic_population._get_vertex, postsynaptic_population._get_vertex, label=label)
        ...
        if connector is not None and synapse_list is None:
            self._synapse_list = \
                connector.generate_synapse_list(presynaptic_population, postsynaptic_population,
