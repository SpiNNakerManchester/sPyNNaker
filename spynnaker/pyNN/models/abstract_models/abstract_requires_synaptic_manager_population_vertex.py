...
class AbstractRequiresSynapticManagerPopulationVertex(
    ...
    def retrieve_edge_constraints_for_senders(self):
        ...
        constraints = list()
        constraints.extend(
            self._retrieve_master_pop_sender_edge_constraints())
        constraints.extend(
            self._retrieve_data_specable_edge_constraints_for_senders())
        return constraints
    ...
    def retrieve_edge_constraints_for_receivers(self):
        ...
        constraints = list()
        constraints.extend(
            self._retrieve_master_pop_receiver_edge_constraints())
        constraints.extend(
            self._retrieve_data_specable_edge_constraints_for_receivers())
        return constraints
