...
class RateSourceArrayVertex(ApplicationVertex, AbstractGeneratesDataSpecification,
    ...
    def __init__(
        ...
        self.__model = model
        #CURRENTLY LIMITED TO 1 SOURCE TO BE EXPANDED IN THE FUTURE!!!!!
        self.__n_atoms = 1
    ...
    def create_machine_vertex(
        ...
        return RateSourceArrayMachineVertex(
    ...
    def _write_rate_parameters(
        ...
        spec.write_value(len(self.__rate_times))
        ...
        for i in range(len(self.__rate_times)):
            spec.write_value(self.__rate_times[i], data_type=DataType.UINT32)
            spec.write_value(self.__rate_values[i], data_type=DataType.S1615)
