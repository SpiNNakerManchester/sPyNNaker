...
class NeuronRecorder(object):
    ...
    N_BYTES_PER_RATE = BYTES_PER_WORD

    #: size of the enum type for the state struct
    N_BYTES_PER_ENUM = BYTES_PER_WORD
    ...
    def get_sdram_usage_in_bytes(self, vertex_slice):
        ...
        return self.N_ITEM_TYPES * BYTES_PER_WORD + var_bytes + bitfield_bytes
