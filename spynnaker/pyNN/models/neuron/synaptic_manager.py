...
class SynapticManager(
    ...
    def _write_synapse_parameters( #probably needs to be DUPLICATED (not moved) on neuron!!
    ...
    def write_data_spec( #NOT SURE IF STILL NECESSARY AT THE END
