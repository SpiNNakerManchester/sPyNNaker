...
class IFCurrExpIonChannel(AbstractPyNNNeuronModelStandard):
    ...
    @default_initial_values({"v", "isyn_exc", "isyn_inh", "n", "I_k", "Ek", "gK"})
    def __init__(
            self, tau_m=20.0, cm=1.0, v_rest=-65.0, v_reset=-65.0,
            v_thresh=-50.0, tau_syn_E=5.0, tau_syn_I=5.0, tau_refrac=0.1,
            i_offset=0.0, n=0.0, gK=36, Ek=-77, v=-65.0, I_k=0.0,
...
#             tau_n = 0.0, n_inf = 0.0
        ...
        additional_input_type = AdditionalInputIonChannel(n, gK, I_k, Ek)
