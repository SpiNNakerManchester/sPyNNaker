...
from spynnaker.pyNN.models.neuron.synapse_types.synapse_type_comb_exp_7E7I_no_init\
    import SynapseTypeCombExp7E7I_no_init
...
class IFCurrCombExp7E7I_no_init(AbstractPopulationVertex):
    ...
    def __init__(
        ...
        synapse_type = SynapseTypeCombExp7E7I_no_init(
                n_neurons,
        ...
        AbstractPopulationVertex.__init__(
            ...
            binary="IF_curr_comb_exp_7E7I_no_init.aplx",
            label=label,
            max_atoms_per_core=IFCurrCombExp7E7I_no_init._model_based_max_atoms_per_core,
            spikes_per_second=spikes_per_second,
            ring_buffer_sigma=ring_buffer_sigma,
            incoming_spike_buffer_size=incoming_spike_buffer_size,
            model_name="IF_curr_comb_exp_7E7I_no_init", neuron_model=neuron_model,
            input_type=input_type, synapse_type=synapse_type,
            threshold_type=threshold_type, constraints=constraints,
            max_feasible_atoms_per_core=IFCurrCombExp7E7I_no_init._max_feasible_max_atoms_per_core)

    @staticmethod
    def set_model_max_atoms_per_core(new_value):
        IFCurrCombExp7E7I_no_init._model_based_max_atoms_per_core = new_value

    @staticmethod
    def get_max_atoms_per_core():
        return IFCurrCombExp7E7I_no_init._model_based_max_atoms_per_core
