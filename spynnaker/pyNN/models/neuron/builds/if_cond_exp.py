...
class IFConductanceExponentialPopulation(AbstractPopulationVertex):
    """
    IFConductanceExponentialPopulation: model which represents a leaky integrate
    and fire model with a exponetial decay curve and based off conductance.
    """
    ...
    def __init__(self, n_neurons, machine_time_step, timescale_factor,
                 ...
                 i_offset=0, e_rev_E=0, e_rev_I=-70, v_init=None):
