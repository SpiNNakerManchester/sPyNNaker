...
class IFCurrExpERBPad(AbstractPyNNNeuronModelStandard):
    ...
    def __init__(
        ...
        neuron_model = NeuronModelLeakyIntegrateAndFireERBPad(
            v, v_rest, tau_m, cm, i_offset, v_reset, tau_refrac, local_err,
            tau_err, target_rate)

        synapse_type = SynapseTypeERBPad(
        ...
        super(IFCurrExpERBPad, self).__init__(
            model_name="LIF_current_erbp_ad", binary="LIF_current_erbp_ad.aplx",
