...
class IzkCondExpBase(AbstractPyNNNeuronModelStandard):
    ...
    :param a: :math:`a`
    :type a: float, iterable(float), RandomDistribution
        or (mapping) function
    :param b: :math:`b`
    :type b: float, iterable(float), RandomDistribution
        or (mapping) function
    :param c: :math:`c`
    :type c: float, iterable(float), RandomDistribution
        or (mapping) function
    :param d: :math:`d`
    :type d: float, iterable(float), RandomDistribution
        or (mapping) function
    :param i_offset: :math:`I_{offset}`
    :type i_offset: float, iterable(float), RandomDistribution
        or (mapping) function
    :param u: :math:`u_{init} = \\delta V_{init}`
    :type u: float, iterable(float), RandomDistribution
        or (mapping) function
    ...
    :type e_rev_E: float, iterable(float), RandomDistribution
        or (mapping) function
    :param e_rev_I: :math:`E^{rev}_i`
    :type e_rev_I: float, iterable(float), RandomDistribution
        or (mapping) function
