...
class IFCurrentTargetExponentialPopulation(AbstractPopulationVertex):
    ...
    def __init__(
        ...
        AbstractPopulationVertex.__init__(
            ...
            max_atoms_per_core=IFCurrentTargetExponentialPopulation._model_based_max_atoms_per_core,
            machine_time_step=machine_time_step,
            timescale_factor=timescale_factor,
            spikes_per_second=spikes_per_second,
            ring_buffer_sigma=ring_buffer_sigma,
            model_name="IF_curr_target_exp", neuron_model=neuron_model,
