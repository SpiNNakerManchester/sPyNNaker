...
class SynapseIORowBased(AbstractSynapseIO):
    ...
    def get_sdram_usage_in_bytes(
        ...
        if static_synapse_dynamics is not None:
            undelayed_static_size = \
                static_synapse_dynamics.get_n_words_for_static_connections(
        ...
        if plastic_synapse_dynamics is not None:
            undelayed_plastic_size = \
                plastic_synapse_dynamics.get_n_words_for_plastic_connections(
                    total_plastic_undelayed_row_length)
            delayed_plastic_size = \
                plastic_synapse_dynamics.get_n_words_for_plastic_connections(
    ...
    def _get_max_row_length_and_row_data(
            ...
            weight_scales, synapse_type, population_table):
