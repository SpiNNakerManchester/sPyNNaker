...
class MeanfieldImplStandard(AbstractNeuronImpl):
    ...
    def __init__(
            self, model_name, binary, neuron_model, config, input_type,
            mathsbox, synapse_type, threshold_type, additional_input_type=None):
        """
        ...
        self.__components = [
            self.__neuron_model, self.__config, self.__mathsbox, self.__input_type, self.__threshold_type,
            self.__synapse_type]
