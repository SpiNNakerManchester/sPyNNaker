...
class AbstractPopulationVertex(
    ...
    def __init__(
        ...
        :param int timestep_in_us:
            timestep used by this vertex
            or None to use the user defined timestep
        :type timestep_in_us: None or int
        """
        # pylint: disable=too-many-arguments, too-many-locals
        ApplicationTimestepVertex.__init__(
            self, label, constraints, max_atoms_per_core, timestep_in_us)
    ...
    def regenerate_data_specification(
            self, spec, placement, time_scale_factor, routing_info):
    ...
    @overrides(
        ...
        additional_arguments={
            ...
            "data_simtime_in_us", "n_key_map"
        })
    def generate_data_specification(
            self, spec, placement, machine_time_step, time_scale_factor,
            application_graph, machine_graph, routing_info, data_simtime_in_us,
            n_key_map):
        """
        ...
        self.__synapse_manager.write_data_spec(
            ...
            application_graph, routing_info, weight_scale, self.timestep_in_us)
    ...
    def get_spikes(self, placements, buffer_manager):
        return self.__neuron_recorder.get_spikes(
            ...
            placements, self, NeuronRecorder.SPIKES)
