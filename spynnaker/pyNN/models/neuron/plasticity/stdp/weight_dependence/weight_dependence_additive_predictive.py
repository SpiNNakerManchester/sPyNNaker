...
class WeightDependenceAdditivePredictive(
    ...
    def __init__(self, w_min=0.0, w_max=1.0):
        super(WeightDependenceAdditivePredictive, self).__init__()
        self.__w_min = w_min
        self.__w_max = w_max
    ...
    def is_same_as(self, weight_dependence):
        if not isinstance(weight_dependence, WeightDependenceAdditivePredictive):
            return False
        return (
