...
from .weight_dependence_additive_predictive import WeightDependenceAdditivePredictive
...
__all__ = ["AbstractHasAPlusAMinus", "AbstractWeightDependence",
           ...
           "WeightDependenceAdditiveTriplet", "WeightDependenceAdditivePredictive"]
