...
class WeightDependenceCyclic(AbstractWeightDependence):
    ...
    def __init__(self,
        w_min_excit = default_parameters['w_min_excit'], w_max_excit  = default_parameters['w_max_excit'],
            A_plus_excit  = default_parameters['A_plus_excit'], A_minus_excit  = default_parameters['A_minus_excit'],
        w_min_excit2 = default_parameters['w_min_excit2'], w_max_excit2 = default_parameters['w_max_excit2'],
            A_plus_excit2 = default_parameters['A_plus_excit2'], A_minus_excit2 = default_parameters['A_minus_excit2'],
        w_min_inhib  = default_parameters['w_min_inhib'], w_max_inhib = default_parameters['w_max_inhib'],
            A_plus_inhib = default_parameters['A_plus_inhib'], A_minus_inhib = default_parameters['A_minus_inhib'],
        w_min_inhib2= default_parameters['w_min_inhib2'], w_max_inhib2= default_parameters['w_max_inhib2'],
            A_plus_inhib2= default_parameters['A_plus_inhib2'], A_minus_inhib2= default_parameters['A_minus_inhib2']):
    ...
    def is_same_as(self, weight_dependence):
        if not isinstance(weight_dependence, WeightDependenceCyclic):
            return False
        return (
    ...
    def get_parameters_sdram_usage_in_bytes(
        ...
        if n_weight_terms != 1:
            raise NotImplementedError(
                "Cyclic weight dependence only supports single terms")
