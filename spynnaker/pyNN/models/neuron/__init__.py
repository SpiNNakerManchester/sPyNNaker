...
from .population_machine_local_only_synapses_vertex_lead import (
    PopulationMachineLocalOnlySynapsesVertexLead)
from .population_machine_local_only_synapses_vertex_shared import (
