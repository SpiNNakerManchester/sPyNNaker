...
class PopulationMachineVertex(
    ...
    def __init__(
            self, resources_required, recording_regions, label, constraints):
        """

        :param resources_required:
        :param recording_regions:
        :param label:
        :param constraints:
        :type sampling: bool
        """
        ...
        self._recording_regions = recording_regions
    ...
    def is_recording(self):
        return len(self._recording_regions) > 0
    ...
    def get_recorded_region_ids(self):
        return self._recording_regions
