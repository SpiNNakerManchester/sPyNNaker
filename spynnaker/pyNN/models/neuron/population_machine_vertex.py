...
class PopulationMachineVertex(
    ...
    def generate_data_specification(
        ...
        self._app_vertex.synapse_manager.write_data_spec(
            spec, self._app_vertex, vertex_slice, vertex, machine_graph,
    ...
    def requires_memory_regions_to_be_reloaded(self):
        return self._app_vertex.requires_memory_regions_to_be_reloaded()

    def mark_regions_reloaded(self):
        self._app_vertex.mark_regions_reloaded()
    ...
    def _write_neuron_parameters(
            self, spec, key, vertex_slice, region_id):
        ...
        data = self._app_vertex.generate_tdma_data_specification_data(
            self._app_vertex.vertex_slices.index(vertex_slice))
