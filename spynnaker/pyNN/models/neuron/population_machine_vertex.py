...
class PopulationMachineVertex(
    ...
    def __init__(
        ...
        self.__minimum_buffer_sdram_usage = minimum_buffer_sdram_usage
        self.__buffered_sdram_per_timestep = buffered_sdram_per_timestep
        self.__overflow_sdram = overflow_sdram
    ...
    def get_minimum_buffer_sdram_usage(self):
        return sum(self.__minimum_buffer_sdram_usage)

    @overrides(AbstractReceiveBuffersToHost.get_n_timesteps_in_buffer_space)
    def get_n_timesteps_in_buffer_space(self, buffer_space, machine_time_step):
        safe_space = buffer_space - self.__overflow_sdram
        return recording_utilities.get_n_timesteps_in_buffer_space(
            safe_space, self.__buffered_sdram_per_timestep)

    @overrides(AbstractReceiveBuffersToHost.get_recorded_region_ids)
    def get_recorded_region_ids(self):
        return recording_utilities.get_recorded_region_ids(
            self.__buffered_sdram_per_timestep)
