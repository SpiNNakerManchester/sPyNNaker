...
class InputTypeDeltaConductance(AbstractInputType):
    """ The delta-conductance input type
    """
    __slots__ = [
        "__e_rev_E",
        "__e_rev_I"]
    ...
    def __init__(self, e_rev_E, e_rev_I):
        super(InputTypeDeltaConductance, self).__init__([
    ...
    def get_values(self, parameters, state_variables, vertex_slice, ts):
        ...
        return [parameters[E_REV_E], parameters[E_REV_I], scale_factor]
