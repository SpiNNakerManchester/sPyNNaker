...
class IzhikevichComponent(AbstractModelComponent):
    """
    IzhikevichComponent
    """

    def __init__(self, n_keys, a=0.02, c=-65.0, b=0.2, d=2.0, i_offset=0,
                 u_init=-14.0, v_init=-70.0):

        AbstractModelComponent.__init__(self)
        self._a = utility_calls.convert_param_to_numpy(a, n_keys)
        self._b = utility_calls.convert_param_to_numpy(b, n_keys)
        self._c = utility_calls.convert_param_to_numpy(c, n_keys)
        self._d = utility_calls.convert_param_to_numpy(d, n_keys)
