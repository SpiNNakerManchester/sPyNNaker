...
class NeuronModelLeakyIntegrateAndFireERBPad(AbstractNeuronModel):
    __slots__ = [
        "_v_init",
        "_v_rest",
        "_tau_m",
    ...
    def __init__(
        ...
        super(NeuronModelLeakyIntegrateAndFireERBPad, self).__init__(
            [DataType.S1615,   # v
    ...
    def update_values(self, values, parameters, state_variables):
        ...
        (v, _v_rest, _r_membrane, _exp_tc, _i_offset, count_refrac,
         _v_reset, _tau_refrac, local_err, _exp_tc_err, _target_rate, z, a) = values
