...
class NeuronModelLeakyIntegrateAndFireTwoComp(AbstractNeuronModel):
    __slots__ = [
        "__u_init",
        "__u_rest",
        "__tau_m",
    ...
    def __init__(
        ...
        super(NeuronModelLeakyIntegrateAndFireTwoComp, self).__init__(
