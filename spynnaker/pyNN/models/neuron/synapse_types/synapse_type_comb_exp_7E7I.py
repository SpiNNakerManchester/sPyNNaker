...
class SynapseTypeCombExp7E7I(AbstractSynapseType):
    ...
    def __init__(self,
        ...
        self.exc6_a_A, self.exc6_b_B = set_excitatory_scalar(self._exc6_a_tau, self._exc6_b_tau)
        ...
        self.exc7_a_A, self.exc7_b_B = set_excitatory_scalar(self._exc7_a_tau, self._exc7_b_tau)
